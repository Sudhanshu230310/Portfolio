...
export default function Skills(){
    return<>
        < motion.div id="skill" className=" w-screen min-h-screen sm:px-28 flex flex-col justify-center items-center sm:items-start lg:gap-0 bg-black">
            <motion.div initial={{x:-30,opacity:0}} whileInView={{x:0,opacity:1, transition:{duration:2}}} className="md:text-5xl w-full text-4xl font-bold text-white mt-4 flex gap-2 sm:pl-12 pb-10 pl-14 bg-black"><div className="text-blue-500">My</div><div>Skills</div></motion.div>
