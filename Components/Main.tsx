            ...
            <motion.div id="main" className="bg-black w-screen min-h-screen sm:px-28 px-6 flex flex-col justify-center gap-20 lg:gap-0">
                <div className="md:flex md:flex-row md:justify-between md:items-center flex-wrap-reverse flex flex-col-reverse justify-center items-center gap-6">
                    <div className="text-white md:flex md:flex-col md:items-start md:gap-8 flex flex-col items-center gap-4 mt-24">
                        <motion.div whileHover={{ scale: 1.1, backgroundColor: "#3b82f6" }} initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1, transition: { duration: 1, delay: 2.5 } }} className="md:text-5xl font-bold text-4xl flex justify-center items-center pl-8 sm:pl-0 bg-gradient-to-r to-blue-800 from-white from-0% to-50% bg-clip-text text-transparent cursor-pointer">Hi, I'm Sudhanshu Gaur</motion.div>
                        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1, transition: { duration: 1, delay: 2.8 } }} className="md:text-2xl text-xl flex justify-center items-center pl-8 md:pl-0">I'm a Competitive Coder, Web Developer and a DevOps enthusiast.</motion.div>
