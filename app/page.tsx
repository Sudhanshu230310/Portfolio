...
export default function Home() {
  return (<>
    <motion.div className="w-screen h-screen bg-black flex justify-center items-center" initial={{visibility:"visible"}} animate={{display:"none", transition:{duration:2,ease:"easeInOut"}}}>
      <motion.div className="md:text-3xl text-xl font-semibold text-white" initial={{y:-20,opacity:0}} animate={{y:0,opacity:1,transition:{delay:0.5,duration:0.5}}}>Full Stack Developer | DevOps </motion.div>
    </motion.div>
